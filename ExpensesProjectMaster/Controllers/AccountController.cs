...
namespace ExpensesProjectMaster.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Register()
        {
            ...
            ViewBag.Teams = new SelectList(db.Teams.Select(t => t.TeamName));
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var employee = new Employee
                {
                    ...
                    TeamID = db.Teams.Where(t => t.TeamName.Equals(model.TeamName, StringComparison.OrdinalIgnoreCase)).FirstOrDefault().TeamID
                };
